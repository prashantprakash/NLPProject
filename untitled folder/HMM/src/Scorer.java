...
public class Scorer {
	...
	public static void main(String[] args) {
		...
		File outputTagFile = new File("/Users/Prashant/NLPProject/brown-test-sentences_Viterbi_tag.txt");
		File testFile = new File("/Users/Prashant/NLPProject/brown-test-sentences.txt");
		File trainFile = new File("/Users/Prashant/NLPProject/brown-train-sentences.txt");
		FileWriter outFile;

		try {
			outFile = new FileWriter(new File("/Users/Prashant/NLPProject/score.html"));
			...
			while (testScanner.hasNext() && outputScanner.hasNext() && test.hasNext()) {
				...
				// tagChosenForTag.get(testPOS).put(outputPOS,
				// tagChosenForTag.get(testPOS).get(outputPOS)+1);

				/* if (!testWord.equals(testWord)) {
